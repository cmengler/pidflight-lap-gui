...
const LINUX_INSTALL_DIR = '/opt/pidflight';
...
var nwBuilderOptions = {
    ...
    macPlist: { 'CFBundleDisplayName': 'PIDflight Lap'},
...
function release_zip(arch) {
    ...
    return compressFiles(src, base, output, 'PIDflight Lap');
}
        ...
        .pipe(appdmg({
            ...
            specification: {
                ...
                contents: [
                    ...
                    { 'x': 192, 'y': 344, 'type': 'file', 'path': pkg.name + '.app', 'name': 'PIDflight Lap.app' }
                ],
